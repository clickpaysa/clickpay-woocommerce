 ...
 * @since 1.0.3
 */
final class WC_Gateway_Clickpay_Blocks_Support extends AbstractPaymentMethodType
{
	/**
	 ...
	 */
	public $gateways = [];
	public $id = "clickpay_blocks";

	protected $name = 'clickpay_blocks';
	...
	public function get_gateways()
	{
		...
		foreach ($gateways as $gateway) {
			if (str_starts_with($gateway->id, "clickpay_") && $gateway->enabled == "yes") {
	...
	public function get_payment_method_script_handles()
	{
		...
		$script_asset_path = CLICKPAY_PAYPAGE_DIR . 'assets/js/frontend/blocks.asset.php';
		...
		$script_url = CLICKPAY_PAYPAGE_URL . $script_path;
